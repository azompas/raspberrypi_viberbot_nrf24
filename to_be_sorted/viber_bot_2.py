...
with open('/home/anastasis/credentials/viber_bot_credentials.yaml', 'r') as cred_yaml:
...
def incoming():
	...
	if isinstance(viber_request, ViberMessageRequest):
		...
		viber.send_messages(viber_request.sender.id, [
			#~ message
			TextMessage(text=u"Hello {}".format(viber_request.sender.name))
		])
...
def set_webhook(viber):
	viber.set_webhook('https://a4869468.ngrok.io')
